...
1. **Case Sensitivity:**
   C is strictly case-sensitive (`Main`, `MAIN`, and `main` are completely different).
2. **Main Entry Point:** 
   Every executable C program MUST have exactly one `main()` function. Execution always starts here.
3. **Semicolons `;`:**
     Every individual statement must end with a semicolon `;` (acts like a full stop in English).
4. **Header Files:** 
